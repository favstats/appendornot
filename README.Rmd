...
Write csv file with `save_csv`. The function will automatically create a new csv or append the file if it already does.
...
You can also create a folder (if it doesn't exist yet) before it saves the csv.
...
Write text file with `save_lines`. The function will automatically create a new text file or append the file if it already does.
